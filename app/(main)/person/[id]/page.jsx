...
import { PlusCircle, ArrowLeftRight, ArrowLeft, Bell, MessageCircle } from "lucide-react";
...
export default function PersonExpensesPage() {
  ...
  const sendReminder = useConvexMutation(api.messages.sendReminder);
  ...
  const handleReminder = async () => {
    if (balance <= 0) {
      toast.error("They don't owe you anything right now.");
      return;
    }
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-4 justify-between">
          ...
          <div className="flex gap-2 flex-wrap">
            ...
            {/* Reminder button — only when they owe you */}
            {balance > 0 && (
              <Button
                variant="outline"
